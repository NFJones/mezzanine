...
| `list-themes` | Return built-in UI themes and configured custom themes, marking the active theme, whether each entry comes from the built-in registry or configuration, and a short unicode block color palette preview for easier theme selection. |
