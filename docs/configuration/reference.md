...
| `terminal.zen_focus_label_duration_ms` | integer | `1000` | Staged zen focus-label lifetime, 0–60000 milliseconds; zero disables. Configuration/migration support is implemented; rendering is pending. Positive changes affect future labels only. |
