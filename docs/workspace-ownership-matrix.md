...
| `src/terminal/profile.rs`, `screen.rs` | root product adapters over `mez-terminal` | temporary | Rename/narrow to explicit product adapters and remove forwarding exports. OSC 133 transaction interpretation may remain product-owned. |
