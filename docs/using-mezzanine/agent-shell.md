...
prompt appears at the bottom of that pane rather than as a separate full-window
surface. The agent works from the pane working directory, its conversation
