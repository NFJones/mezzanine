...
pub const UI_COLOR_SLOT_NAMES: &[&str] = &[
    ...
    "iroh_status_good_fg",
    "iroh_status_good_bg",
    "iroh_status_degraded_fg",
    "iroh_status_degraded_bg",
    "iroh_status_poor_fg",
    "iroh_status_poor_bg",
    "iroh_status_unknown_fg",
    "iroh_status_unknown_bg",
    "prompt_fg",
    "prompt_bg",
    "agent_prompt_fg",
    "agent_prompt_bg",
    ...
    "agent_approval_attention_fg",
    "agent_approval_attention_bg",
...
pub struct UiThemeColors {
    ...
    /// Determinate terminal progress pill beside the pane title.
    pub pane_progress: UiColorPair,
    ...
    /// Healthy Iroh connection status pill.
    pub iroh_status_good: UiColorPair,
    /// Degraded Iroh connection status pill.
    pub iroh_status_degraded: UiColorPair,
    /// Poor Iroh connection status pill.
    pub iroh_status_poor: UiColorPair,
    /// Unknown or stale Iroh connection status pill.
    pub iroh_status_unknown: UiColorPair,
    /// Command prompt rows.
    ...
    /// Approval-required attention flash for pane, window, and group pills.
    pub agent_approval_attention: UiColorPair,
...
pub fn builtin_ui_theme_definition(name: &str) -> Option<UiThemeDefinition> {
    match name {
        ...
        "acid_lemon" => Some(acid_lemon_ui_theme_definition()),
        "acid_tangerine" => Some(acid_tangerine_ui_theme_definition()),
...
pub fn resolve_ui_theme(name: &str, definition: UiThemeDefinition) -> Result<UiTheme> {
    ...
    let colors = UiThemeColors {
        ...
        pane_progress: pair_from_slots(&definition.colors, &aliases, "pane_progress")?,
        ...
        iroh_status_good: pair_from_slots(&definition.colors, &aliases, "iroh_status_good")?,
        iroh_status_degraded: pair_from_slots(
            &definition.colors,
            &aliases,
            "iroh_status_degraded",
        )?,
        iroh_status_poor: pair_from_slots(&definition.colors, &aliases, "iroh_status_poor")?,
        iroh_status_unknown: pair_from_slots(&definition.colors, &aliases, "iroh_status_unknown")?,
        ...
        agent_transcript_peer_sender: pair_from_slots(
            &definition.colors,
            &aliases,
        ...
        agent_approval_attention: pair_from_slots(
            &definition.colors,
            &aliases,
...
pub fn deepforest_ui_theme() -> UiTheme {
    ...
    UiTheme {
        ...
        colors: UiThemeColors {
            ...
            pane_progress: pair("#0b1f17", "#d7c46a"),
            pane_pwd: pair("#0b1f17", "#8fa99a"),
            window_status_uptime: pair("#0b1f17", "#3f8f68"),
            window_status_datetime: pair("#0b1f17", "#d7c46a"),
            iroh_status_good: pair("#0b1f17", "#57c785"),
            iroh_status_degraded: pair("#0b1f17", "#d7c46a"),
            iroh_status_poor: pair("#0b1f17", "#c05f5f"),
            iroh_status_unknown: pair("#0b1f17", "#8fa99a"),
            ...
            agent_approval_attention: pair("#e4efe8", "#c05f5f"),
...
/// Returns the curated built-in acid_lime theme definition.
fn acid_lime_ui_theme_definition() -> UiThemeDefinition {
    definition_from_palette(UiThemePalette {
        ...
        thinking: "#b8bea8",
        danger: "#ff5c57",
        agent_prompt_background: "#20250c",
    })
}
