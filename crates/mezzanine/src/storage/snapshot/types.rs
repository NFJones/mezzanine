...
use crate::host::terminal::{DEFAULT_PANE_FRAME_TEMPLATE, DEFAULT_WINDOW_FRAME_TEMPLATE};
    ...
    fn default() -> Self {
        Self {
            window: SnapshotFrameSettings {
                ...
                visible_fields: crate::host::terminal::DEFAULT_WINDOW_FRAME_VISIBLE_FIELDS
                    .iter()
            ...
            pane: SnapshotFrameSettings {
                ...
                visible_fields: crate::host::terminal::DEFAULT_PANE_FRAME_VISIBLE_FIELDS
                    .iter()
                    .map(|field| (*field).to_string())
                    .collect(),
            },
