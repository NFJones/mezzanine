...
__mez_bash_receiver() {
    ...
    READLINE_POINT=0
    READLINE_MARK=0
    IFS=' ' builtin read -r MEZ_BASH_RECEIVER_KIND MEZ_BASH_RECEIVER_FRAME_TOKEN MEZ_BASH_RECEIVER_FRAME_MARKER MEZ_BASH_RECEIVER_LENGTH MEZ_BASH_RECEIVER_DIGEST MEZ_BASH_RECEIVER_CHUNKS || { __mez_bash_receiver_reset; return 1; }
