...
fn runtime_show_metrics_reports_privacy_safe_iroh_diagnostics() {
    ...
    for expected in [
        ...
        "[x11 forwarding]",
        "route_active = false",
        "authority_repair_pending = false",
        "active_streams = 0",
...
fn runtime_show_iroh_status_reports_connection_quality_without_topology() {
    ...
    for expected in [
        ...
        "| Render updates | snapshots 1 · deltas 1 · changed rows 25 |",
        "selected wire 176 B · decoded 608 B · snapshot candidates 1.0 KiB",
        "coalesced 4 · suppressed 1 · snapshot fallbacks 1",
