...
fn ui_theme_colors_json(theme: &UiTheme) -> String {
    format!(
        ...
        ui_color_pair_json(theme.colors.pane_progress),
        ...
        ui_color_pair_json(theme.colors.agent_transcript_peer_sender),
        ui_color_pair_json(theme.colors.agent_transcript_peer_receiver),
        ui_color_pair_json(theme.colors.agent_transcript_parent),
