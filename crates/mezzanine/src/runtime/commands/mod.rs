...
use super::{
    ...
    ContextSourceKind, DEFAULT_AUTO_SIZING_ROUTER_PROFILE, EventKind, HookEvent, MemoryRecord,
    ...
    agent_shell_visibility_json_name, compose_effective_config, current_unix_seconds,
...
impl RuntimeSessionService {
    ...
    pub(super) fn cancel_live_shell_transactions_for_turn(
        ...
        self.retire_action_presentation_progress_for_turn(turn_id)?;
