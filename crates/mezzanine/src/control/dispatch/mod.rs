...
#[cfg(test)]
use super::dispatch_snapshot_request;
...
use super::{
    ...
    MAX_EVENT_REPLAY_RETENTION, McpRegistry, MezError, PaneCaptureSource, PaneSizeSpec,
    RequestedRole, ResizeAxis, ResizeDirection, Result, ServerIdentity, Session,
    ...
    authorize_control_request, client_json, clients_json_for_params, config_audit_outcome,
    config_audit_plan, config_request_cache_key, config_response_advances_generation,
    destination_target_checked_resolved, dispatch_agent_list_with_store_and_model_profiles,
    dispatch_agent_shell_command_with_store, dispatch_agent_shell_visibility_with_store,
    dispatch_agent_task_list_with_ledger, dispatch_config_parsed_request,
    dispatch_config_parsed_to_response_cached, dispatch_event_list_request,
    dispatch_pane_capture_request, dispatch_snapshot_request_with_context, error_code,
    frame_read_json, initialize, initialize_params_from_json, initialize_result_json,
    is_config_control_method, json_bool_field, json_escape, json_null_field, json_object_field,
    json_raw_field, json_rpc_error, json_rpc_success, json_string_field, layout_state_json,
    mcp_servers_json, mcp_tools_json, mezzanine_error_code, negotiate_protocol_version,
    ...
    parse_join_position, parse_json_object_value, parse_json_rpc_request, parse_split_direction,
    parse_trust_decision, project_trust_state_filter_from_params, reject_unknown_json_fields,
    require_idempotency_key, require_session_target_matches_value, session_state_json_for_params,
    session_summary_json, source_pane_target_checked_resolved, target_or_active_pane,
    validate_agent_task_list_params, validate_config_control_params_schema, window_by_id,
    window_id_for_target, window_state_json, window_target_checked_resolved,
...
#[cfg(test)]
pub use connection::handle_control_frames_for_connection;
pub use connection::{
