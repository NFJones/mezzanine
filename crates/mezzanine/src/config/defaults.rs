...
# Opt-in read-only Rust, Zig, Go, Deno, Bun, Node.js, Python, or JDK projections;
# detect with `--kind rust|zig|go|deno|bun|node|python|jdk`, then enable ordered
...
# toolchains = ["rust", "zig", "go", "deno", "bun", "node", "python", "jdk"]
