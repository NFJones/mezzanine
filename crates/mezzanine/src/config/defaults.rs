...
# Pane echo of peer and runtime bridge MMP traffic: `normal` logs only canonical
# `text/plain; charset=utf-8` payloads; JSON, binary, and absent media types
# remain durable and model-visible without pane rows. `verbose` logs the full
# bounded raw payload for every peer echo, bridge traffic included.
