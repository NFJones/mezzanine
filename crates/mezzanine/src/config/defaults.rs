...
# Pane echo of peer and runtime bridge MMP traffic: `normal` keeps the echo of
# model-authored peer mail and suppresses the echo of runtime-owned subagent
# bridge notifications, because each bridge notification already has its own
# `subagent ...` status/result line; `verbose` logs the full bounded payload for
# every peer echo, bridge traffic included.
