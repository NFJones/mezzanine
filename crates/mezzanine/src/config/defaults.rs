...
enabled_actions = ["say", "shell_command", "apply_patch", "web_search", "fetch_url", "send_message", "wait", "spawn_agent", "config_change", "mcp_server_search", "mcp_server_get", "mcp_call", "memory_search", "memory_store", "list_agents", "issue_add", "issue_update", "issue_query", "issue_delete"]
