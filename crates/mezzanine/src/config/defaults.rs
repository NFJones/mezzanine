...
# Opt-in read-only Rust, Zig, Go, Deno, Bun, Node.js, Python, JDK, .NET, Dart, Kotlin/JVM, Ruby, PHP, Composer, Erlang/OTP, Elixir, GHC, Cabal, or Stack projections;
# detect with `--kind rust|zig|go|deno|bun|node|python|jdk|dotnet|dart|kotlin|ruby|php|composer|erlang|elixir|ghc|cabal|stack`, then enable ordered
...
# toolchains = ["rust", "zig", "go", "deno", "bun", "node", "python", "jdk", "dotnet", "dart", "kotlin", "ruby", "php", "composer", "erlang", "elixir", "ghc", "cabal", "stack"]
