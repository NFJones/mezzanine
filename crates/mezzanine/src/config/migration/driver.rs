...
use super::v79_v80::migrate_v79_to_v80;
use super::v80_v81::migrate_v80_to_v81;
use super::v81_v82::migrate_v81_to_v82;
use super::v82_v83::migrate_v82_to_v83;
use super::v83_v84::migrate_v83_to_v84;
use super::v84_v85::migrate_v84_to_v85;
use super::v85_v86::migrate_v85_to_v86;
...
use super::v90_v91::migrate_v90_to_v91;
use super::v91_v92::migrate_v91_to_v92;
use super::v92_v93::migrate_v92_to_v93;
...
pub const CURRENT_CONFIG_SCHEMA_VERSION: u64 = 95;
...
pub fn migrate_config_text(format: ConfigFormat, text: &str) -> Result<ConfigMigrationPlan> {
    ...
    while current_version < CURRENT_CONFIG_SCHEMA_VERSION {
        match current_version {
            ...
            75 => {
                current_text = migrate_v75_to_v76(format, &current_text)?;
                current_version = 76;
            }
            76 => {
                current_text = migrate_v76_to_v77(format, &current_text)?;
                current_version = 77;
            }
            77 => {
            ...
            79 => {
                current_text = migrate_v79_to_v80(format, &current_text)?;
                current_version = 80;
            }
            80 => {
                current_text = migrate_v80_to_v81(format, &current_text)?;
                current_version = 81;
            }
            81 => {
                current_text = migrate_v81_to_v82(format, &current_text)?;
                current_version = 82;
            }
            82 => {
                current_text = migrate_v82_to_v83(format, &current_text)?;
                current_version = 83;
            }
            83 => {
                current_text = migrate_v83_to_v84(format, &current_text)?;
                current_version = 84;
            }
            84 => {
                current_text = migrate_v84_to_v85(format, &current_text)?;
                current_version = 85;
            }
            85 => {
                current_text = migrate_v85_to_v86(format, &current_text)?;
                current_version = 86;
            }
            86 => {
                current_text = migrate_v86_to_v87(format, &current_text)?;
                current_version = 87;
            }
            87 => {
                current_text = migrate_v87_to_v88(format, &current_text)?;
                current_version = 88;
            }
            88 => {
            ...
            90 => {
                current_text = migrate_v90_to_v91(format, &current_text)?;
                current_version = 91;
            }
            91 => {
                current_text = migrate_v91_to_v92(format, &current_text)?;
                current_version = 92;
            }
            92 => {
                current_text = migrate_v92_to_v93(format, &current_text)?;
                current_version = 93;
            }
            93 => {
                current_text = migrate_v93_to_v94(format, &current_text)?;
                current_version = 94;
            }
            94 => {
                current_text = migrate_v94_to_v95(format, &current_text)?;
                current_version = 95;
            }
            unsupported => {
                return Err(MezError::config(format!(
