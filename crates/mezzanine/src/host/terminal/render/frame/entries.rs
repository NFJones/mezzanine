...
pub(in crate::host::terminal::render) fn pillbox_segment_local_columns(
    start: usize,
    width: usize,
    frame_width: usize,
...
pub(in crate::host::terminal::render) enum WindowFramePillboxTarget {
...
pub(in crate::host::terminal::render) fn window_frame_action_entry(
    action: WindowFrameAction,
    frame_context: &TerminalFrameContext,
...
pub(in crate::host::terminal::render) fn window_frame_pillbox_entries(
    window: &Window,
    frame_context: &TerminalFrameContext,
...
pub(in crate::host::terminal::render) fn window_frame_pillbox_entries_from_context(
    frame_context: &TerminalFrameContext,
) -> Vec<WindowFramePillboxEntry> {
    frame_context
        .windows
...
pub(in crate::host::terminal::render) fn window_action_pillbox_entries(
    frame_context: &TerminalFrameContext,
) -> Vec<WindowFramePillboxEntry> {
...
pub(in crate::host::terminal::render) fn group_frame_pillbox_entries(
    frame_context: &TerminalFrameContext,
) -> Vec<WindowFramePillboxEntry> {
    frame_context
        .groups
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn window_frame_pillbox_text(
    window: &Window,
    frame_context: &TerminalFrameContext,
) -> String {
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn window_frame_pillbox_text_from_entries(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn window_frame_pillbox_segments(
    entries: &[WindowFramePillboxEntry],
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn window_frame_field_value(
    window: &Window,
    frame_context: &TerminalFrameContext,
    field: &str,
) -> String {
