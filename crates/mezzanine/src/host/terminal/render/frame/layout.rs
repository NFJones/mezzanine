...
pub(in crate::host::terminal::render) fn pane_frame_field_value(
    window: &Window,
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn optional_pane_context_value(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn optional_u32_frame_value(value: Option<u32>) -> String {
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn write_styled_merged_pane_frames_on_dividers(
...
pub(in crate::host::terminal::render) fn write_pane_frame_layout_cells(
