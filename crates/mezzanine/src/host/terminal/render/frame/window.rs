...
pub(in crate::host::terminal::render) fn render_window_frame_template(
    window: &Window,
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn render_window_frame_text(
    window: &Window,
    frame_context: &TerminalFrameContext,
    template: &str,
    width: usize,
...
pub(in crate::host::terminal::render) enum WindowStatusSegmentKind {
...
pub(in crate::host::terminal::render) type WindowStatusSegment =
    FrameStatusSegment<WindowStatusSegmentKind>;

/// Product-specialized right-aligned status placement owned by `mez-mux`.
pub(in crate::host::terminal::render) type WindowRightStatusLayout =
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn window_right_status_layout(
    frame_context: &TerminalFrameContext,
    width: usize,
...
pub(in crate::host::terminal::render) type RenderedWindowStatusTemplate =
    RenderedFrameStatus<WindowStatusSegmentKind>;

/// Product-specialized template field retained before mux placement.
pub(in crate::host::terminal::render) type WindowStatusFieldComponent =
    RenderedFrameStatus<WindowStatusSegmentKind>;
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn render_window_status_template(
    frame_context: &TerminalFrameContext,
...
pub(in crate::host::terminal::render) fn window_status_field_component(
    frame_context: &TerminalFrameContext,
    status: &TerminalWindowStatusContext,
    field: &str,
...
pub(in crate::host::terminal::render) fn window_actions_status_component(
    frame_context: &TerminalFrameContext,
) -> WindowStatusFieldComponent {
...
pub(in crate::host::terminal::render) fn window_action_status_component(
    frame_context: &TerminalFrameContext,
    action: WindowFrameAction,
) -> WindowStatusFieldComponent {
...
pub(in crate::host::terminal::render) fn window_status_template_button_action(
    field: &str,
