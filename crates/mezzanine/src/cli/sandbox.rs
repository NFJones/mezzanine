...
use crate::security::sandbox::{
    BubblewrapManagedHomeMaintenance, RustToolchainHomeDiscovery, SANDBOX_DENO_PATH,
    SANDBOX_GO_PATH, SANDBOX_RUST_PATH, SANDBOX_ZIG_PATH, SandboxDiagnosticSeverity,
    SandboxWorkflowPlan, SandboxWorkflowRequest, clear_bubblewrap_managed_home,
    discover_deno_from_search_path, discover_go_from_search_path, discover_rust_from_home,
...
fn toolchain_result(
    ...
    let (cargo_bin, rustup_home, zig_root, go_root, deno_root, sandbox_path) = match detection {
        ...
        DirectToolchainDetection::Zig(root) => (None, None, root, None, None, SANDBOX_ZIG_PATH),
        DirectToolchainDetection::Go(root) => (None, None, None, root, None, SANDBOX_GO_PATH),
        DirectToolchainDetection::Deno(root) => (None, None, None, None, root, SANDBOX_DENO_PATH),
    };
    SandboxToolchainResult {
        version: 1,
        project_root,
