...
use super::{
    ...
    ModelProfile, ModelProfileOverrideSource, ModelProfileOverrides, ModelProvider, ModelRequest,
    ModelResponse, OpenAiResponsesProvider, PaneShellExecutor, ProviderHttpTransport, Result,
    ...
    select_model_profile, set_project_guidance_context, tool_discovery_script,
...
use mez_agent::{
    ...
    MemoryContextScope, ModelTokenUsage, OPENAI_MODELS_ENDPOINT, OPENAI_RESPONSES_ENDPOINT,
    ProviderHttpRequest, ProviderHttpResponse, ProviderTranscriptEvent, SlashCommandEffect,
