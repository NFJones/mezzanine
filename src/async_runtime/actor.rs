...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_pane_inputs_to_side_effects(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_pane_resizes_to_side_effects(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_pane_terminations_to_side_effects(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_audit_writes_to_side_effects(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_agent_transcript_writes_to_side_effects(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_agent_prompt_history_writes_to_side_effects(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_command_prompt_history_writes_to_side_effects(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_config_file_writes_to_side_effects(
...
fn coalesce_deferred_config_file_writes(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_project_config_writes_to_side_effects(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_project_instruction_writes_to_side_effects(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_pane_pipe_writes_to_side_effects(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_program_hooks_to_side_effects(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn deferred_registry_update_to_side_effect(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
fn pane_exit_status_from_process_event(
