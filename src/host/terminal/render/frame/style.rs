...
pub(in crate::host::terminal::render) fn styled_group_frame_line(
    frame_context: &TerminalFrameContext,
    width: usize,
...
pub(in crate::host::terminal::render) fn styled_window_frame_line(
    window: &Window,
    frame_context: &TerminalFrameContext,
    template: &str,
    width: usize,
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn styled_window_pillbox_line(
    window: &Window,
    frame_context: &TerminalFrameContext,
    width: usize,
    frame_style: TerminalFrameStyle,
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn styled_pane_frame_line(
    window: &Window,
    width: usize,
...
pub(in crate::host::terminal::render) fn pane_frame_right_status_segment_style_spans(
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn pane_frame_right_status_rendition(
    segment: &PaneFrameRightStatusSegment,
    ui_theme: &UiTheme,
) -> GraphicRendition {
    match segment.key {
...
pub(in crate::host::terminal::render) fn pane_frame_agent_routing_rendition(
    value: &str,
    ui_theme: &UiTheme,
) -> GraphicRendition {
    match value {
...
pub(in crate::host::terminal::render) fn pane_frame_latency_rendition(
    value: &str,
    ui_theme: &UiTheme,
) -> GraphicRendition {
    match value {
...
pub(in crate::host::terminal::render) fn pane_frame_policy_mode_rendition(
    value: &str,
    ui_theme: &UiTheme,
) -> GraphicRendition {
...
pub(in crate::host::terminal::render) fn pane_frame_agent_context_usage_rendition(
    value: &str,
    ui_theme: &UiTheme,
) -> GraphicRendition {
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn pane_frame_agent_status_rendition(
    status: &str,
    ui_theme: &UiTheme,
) -> GraphicRendition {
    match status {
...
pub(in crate::host::terminal::render) fn pane_frame_agent_status_is_active(status: &str) -> bool {
    matches!(
        status,
        "queued"
            | "running"
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn subtle_frame_fill_span(
    width: usize,
    frame_style: TerminalFrameStyle,
    ui_theme: &UiTheme,
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn pane_border_rendition(
    active: bool,
    ui_theme: &UiTheme,
) -> GraphicRendition {
    let pair = if active {
...
/// the owning module so callers receive typed results instead of relying
/// on duplicated control-flow logic.
pub(in crate::host::terminal::render) fn themed_frame_rendition(
    pair: UiColorPair,
    frame_style: TerminalFrameStyle,
    bold: bool,
) -> GraphicRendition {
