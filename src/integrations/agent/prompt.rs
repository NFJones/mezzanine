...
static SYSTEM_PROMPTS: Dir<'_> =
    include_dir!("$CARGO_MANIFEST_DIR/src/integrations/agent/prompt/system");

/// Embedded provider-specific prompt fragments owned by this module.
static PROVIDER_PROMPTS: Dir<'_> =
    include_dir!("$CARGO_MANIFEST_DIR/src/integrations/agent/prompt/providers");
