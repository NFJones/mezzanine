...
use schema::{
    ...
    HISTORY_KEYS, HOOK_KEYS, INSTRUCTION_KEYS, KEY_BINDING_KEYS, LAYOUT_KEYS, MCP_SERVER_KEYS,
    MESSAGE_PROTOCOL_KEYS, MODEL_PROFILE_KEYS, PANE_FRAME_KEYS, PERMISSION_KEYS,
