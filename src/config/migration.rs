...
/// - `format`: The concrete config file format.
/// - `text`: The document text to migrate.
fn migrate_v9_to_v10(format: ConfigFormat, text: &str) -> Result<String> {
    match format {
...
/// # Parameters
/// - `text`: The TOML document text to migrate.
fn migrate_toml_v9_to_v10(text: &str) -> Result<String> {
    let mut document = text
        .parse::<toml_edit::DocumentMut>()
        .map_err(|error| MezError::config(format!("invalid TOML config: {error}")))?;
    let default_document = DEFAULT_CONFIG_TOML
...
/// - `format`: The concrete config file format.
/// - `text`: The document text to migrate.
fn migrate_json_compatible_v9_to_v10(format: ConfigFormat, text: &str) -> Result<String> {
    let mut document = parse_json_compatible_config(format, text)?;
    let default_table = toml::from_str::<toml::Table>(DEFAULT_CONFIG_TOML)
        .map_err(|error| MezError::config(format!("invalid built-in default config: {error}")))?;
    let default_document = serde_json::to_value(default_table)
...
/// - `format`: The concrete config file format.
/// - `text`: The document text to migrate.
fn migrate_v10_to_v11(format: ConfigFormat, text: &str) -> Result<String> {
    match format {
...
/// # Parameters
/// - `text`: The TOML document text to migrate.
fn migrate_toml_v10_to_v11(text: &str) -> Result<String> {
    let mut document = text
        .parse::<toml_edit::DocumentMut>()
        .map_err(|error| MezError::config(format!("invalid TOML config: {error}")))?;
    let default_document = DEFAULT_CONFIG_TOML
...
/// - `format`: The concrete config file format.
/// - `text`: The document text to migrate.
fn migrate_json_compatible_v10_to_v11(format: ConfigFormat, text: &str) -> Result<String> {
    let mut document = parse_json_compatible_config(format, text)?;
    let default_table = toml::from_str::<toml::Table>(DEFAULT_CONFIG_TOML)
        .map_err(|error| MezError::config(format!("invalid built-in default config: {error}")))?;
    let default_document = serde_json::to_value(default_table)
...
/// - `format`: The concrete config file format.
/// - `text`: The document text to migrate.
fn migrate_v11_to_v12(format: ConfigFormat, text: &str) -> Result<String> {
    match format {
...
/// # Parameters
/// - `text`: The TOML document text to migrate.
fn migrate_toml_v11_to_v12(text: &str) -> Result<String> {
    let mut document = text
        .parse::<toml_edit::DocumentMut>()
        .map_err(|error| MezError::config(format!("invalid TOML config: {error}")))?;
...
/// - `format`: The concrete config file format.
/// - `text`: The document text to migrate.
fn migrate_json_compatible_v11_to_v12(format: ConfigFormat, text: &str) -> Result<String> {
    let mut document = parse_json_compatible_config(format, text)?;
...
/// - `format`: The concrete config file format.
/// - `text`: The document text to migrate.
fn migrate_v12_to_v13(format: ConfigFormat, text: &str) -> Result<String> {
    match format {
...
/// # Parameters
/// - `text`: The TOML document text to migrate.
fn migrate_toml_v12_to_v13(text: &str) -> Result<String> {
    let mut document = text
        .parse::<toml_edit::DocumentMut>()
        .map_err(|error| MezError::config(format!("invalid TOML config: {error}")))?;
    let default_document = DEFAULT_CONFIG_TOML
...
/// - `format`: The concrete config file format.
/// - `text`: The document text to migrate.
fn migrate_json_compatible_v12_to_v13(format: ConfigFormat, text: &str) -> Result<String> {
    let mut document = parse_json_compatible_config(format, text)?;
    let default_table = toml::from_str::<toml::Table>(DEFAULT_CONFIG_TOML)
        .map_err(|error| MezError::config(format!("invalid built-in default config: {error}")))?;
    let default_document = serde_json::to_value(default_table)
...
/// - `format`: The concrete config file format.
/// - `text`: The document text to migrate.
fn migrate_v14_to_v15(format: ConfigFormat, text: &str) -> Result<String> {
    match format {
...
/// # Parameters
/// - `text`: The TOML document text to migrate.
fn migrate_toml_v14_to_v15(text: &str) -> Result<String> {
    let mut document = text
        .parse::<toml_edit::DocumentMut>()
        .map_err(|error| MezError::config(format!("invalid TOML config: {error}")))?;
    let default_document = DEFAULT_CONFIG_TOML
...
/// - `format`: The concrete config file format.
/// - `text`: The document text to migrate.
fn migrate_json_compatible_v14_to_v15(format: ConfigFormat, text: &str) -> Result<String> {
    let mut document = parse_json_compatible_config(format, text)?;
    let default_table = toml::from_str::<toml::Table>(DEFAULT_CONFIG_TOML)
        .map_err(|error| MezError::config(format!("invalid built-in default config: {error}")))?;
    let default_document = serde_json::to_value(default_table)
...
/// - `format`: The concrete config file format.
/// - `text`: The document text to migrate.
fn migrate_v17_to_v18(format: ConfigFormat, text: &str) -> Result<String> {
    match format {
...
/// # Parameters
/// - `text`: The TOML document text to migrate.
fn migrate_toml_v17_to_v18(text: &str) -> Result<String> {
    let mut document = text
        .parse::<toml_edit::DocumentMut>()
        .map_err(|error| MezError::config(format!("invalid TOML config: {error}")))?;
    let default_document = DEFAULT_CONFIG_TOML
...
/// - `format`: The concrete config file format.
/// - `text`: The document text to migrate.
fn migrate_json_compatible_v17_to_v18(format: ConfigFormat, text: &str) -> Result<String> {
    let mut document = parse_json_compatible_config(format, text)?;
    let default_table = toml::from_str::<toml::Table>(DEFAULT_CONFIG_TOML)
        .map_err(|error| MezError::config(format!("invalid built-in default config: {error}")))?;
    let default_document = serde_json::to_value(default_table)
