...
pub use discovery::{
    default_trust_database_path, discover_existing_overlays, discover_overlay_candidates,
    discover_project_root, discover_project_trust_prompt, select_overlay_for_directory,
    summarize_overlay_capabilities,
};
pub use types::{
